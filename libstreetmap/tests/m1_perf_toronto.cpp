...
////            CHECK(load_map("/cad2/ece297s/public/maps/toronto.streets.bin"));
////        }
////        close_map();
////    }
////}
//
//SUITE(corner_cases) { //corner cases for find_closest_intersection function
//
//    TEST_FIXTURE(MapFixture,find_closest_intersection) {
